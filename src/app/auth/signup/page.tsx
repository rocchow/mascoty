      ...
      <div className="flex min-h-full items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm text-center space-y-4">
          ...
          <p className="text-sm text-muted">
            ...
            activate your account and get your 3 free credits.
          </p>
      ...
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-muted">
            Get 3 free character sheets to start
          </p>
        </div>

        <button
          onClick={handleGoogleSignup}
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-card px-4 py-2.5 text-sm font-medium transition hover:bg-accent-light"
        >
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          {error && (
            <div className="rounded-lg bg-red-50 dark:bg-red-950 p-3 text-sm text-danger">
              {error}
            </div>
          )}
          <div>
